 ...
 *
 * @author bherbst; code modified to accomodate usage in the launcher.
 */
...
public class QuickReturnFooterBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    @Override
    public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, View child, View target, int dx, int dy, int[] consumed, int type) {
