...
class ThemeableListPreference(context: Context?, attrs: AttributeSet?) : ListPreference(context, attrs) {
    override fun onClick() {
        ...
        postDialog.getButton(DialogInterface.BUTTON_NEUTRAL).setTextColor(PreferenceHelper.darkAccent)
        postDialog.getButton(DialogInterface.BUTTON_NEGATIVE).setTextColor(PreferenceHelper.darkAccent)
        postDialog.getButton(DialogInterface.BUTTON_POSITIVE).setTextColor(PreferenceHelper.darkAccent)
    }
}